...
//         <h3 className="font-medium text-2xl mb-4">Your Task<span className='ml-2 text-base'>({tasks.length})</span></h3>
    ...
    <>
      ...
      <div className='container mx-auto p-5 min-h-screen my-4'>
        ...
        <input
          ...
          placeholder="Enter task..."
        />
        <button className="bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-600 mb-8"></button>
        <h3 className="font-medium text-2xl mb-4">Your Task<span className='ml-2 text-base'></span></h3>
        {/* {tasks.map((task, index) => ( */}
        <div key={1} className="flex items-center justify-between mb-2 border rounded-md p-2">
          <div>
            <span className="py-1 px-2.5 bg-black text-white rounded-full">1</span>
            <span className="px-2 font-medium">Do-it</span>
          </div>
          <div>
            <button className="bg-blue-500 hover:bg-blue-700 mr-4 py-1 px-2 text-white rounded">Edit</button>
            <button className="bg-red-500 hover:bg-red-700 py-1 px-2 text-white rounded">Delete</button>
          </div>
        </div>
        {/* ))} */}
      </div>
